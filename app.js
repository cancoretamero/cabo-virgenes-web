...
if (mapSection) {
  ...
  if (isTouch) {
    // Móvil/iOS: NO se carga Leaflet (decenas de tiles + 43 marcadores con
    // animación de pulso agotan la GPU/memoria y crashean Safari). En su lugar
    // se muestra una imagen estática del mapa (ver .map-static en el CSS).
